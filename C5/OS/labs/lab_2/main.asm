...
DATA32 SEGMENT PARA 'DATA'
    GDT_NULL    SEGDESCR<0,0,0,0,0,0>
    GDT_CODE16  SEGDESCR<CODE16_SIZE-1,0,0,98H,0,0>
    GDT_DATA4GB SEGDESCR<0FFFFH,0,0,92H,0CFH,0>
    GDT_CODE32  SEGDESCR<CODE32_SIZE-1,0,0,98H,40H,0>
    ; 98h - 1001 1000
    GDT_DATA32  SEGDESCR<DATA_SIZE-1,0,0,92H,40H,0>
    ; 92h - 1001 0010
    ; 1 - P
    ; 00 - DLP - уровень привелегий 0
    GDT_STACK32 SEGDESCR<STACK_SIZE-1,0,0,92H,40H,0>
    GDT_VIDEO16 SEGDESCR<3999,8000H,0BH,92H,0,0>
