...
int reader_run(int *const shcntr, const int s_id, const int r_id)
{
    if (!shcntr)
    {
        return -1;
...
int writer_run(int *const shcntr, const int s_id, const int w_id)
{
    if (!shcntr)
    {
        return -1;
