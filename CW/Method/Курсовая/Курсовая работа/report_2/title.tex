\begin{titlepage}
	...
	{\itshape К НАУЧНО-ИССЛЕДОВАТЕЛЬСКОЙ РАБОТЕ \\ НА ТЕМУ: \\
	 <<Классификация систем для создания трёхмерной среды для визуализации окружения робота-собеседника Ф-2>>\\}}
	...
	\begin{tabular}{p{0.52\textwidth} c c c}
		...
		Руководитель &
		\underline{\hspace{35mm}} &
		\underline{\smash{Волкова~Л.~Л.}} \\[-0.6em]
